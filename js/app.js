...
// Add this to the DOMContentLoaded event listener in js/app.js
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('logout-btn').addEventListener('click', function() {
        // In a real application with authentication, you would clear session data here
        // For this demo, we'll just show a notification and reload the page
