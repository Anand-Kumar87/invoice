...
function exportToPDF(elementId, filename) {
    ...
    const clientName = clonedElement.querySelector('#preview-client-name').textContent;
    const clientEmail = clonedElement.querySelector('#preview-client-email').textContent;
    const clientPhone = clonedElement.querySelector('#preview-client-phone').textContent;
    const clientAddress = clonedElement.querySelector('#preview-client-address').textContent;
    
    const bankName = clonedElement.querySelector('#preview-bank-name').textContent;
    const accountName = clonedElement.querySelector('#preview-account-name').textContent;
    const accountNumber = clonedElement.querySelector('#preview-account-number').textContent;
    
    // Add logo if available
    if (logoSrc && logoSrc !== 'assets/default-logo.png' && !logoSrc.includes('default-logo.png')) {
